...
function Home() {
    ...
    return (
        <div className="home-container">
            {/* Hero Split Section */}
            <section className="kb-hero-split-section" aria-label="NCB Hero Section">
                <div className="container kb-hero-container">
                    <div className="kb-hero-split-row">

                        {/* LEFT TEXT CONTENT */}
                        <div className="kb-hero-text-col">
                            <span className="kb-ministry-badge animate-fade-in-up">
                                Ministry of Home Affairs
                            </span>

                            <h1 className="kb-hero-split-title animate-fade-in-up">
                                Narcotics
                                <span className="kb-text-gradient-primary">Control Bureau</span>
                            </h1>

                            <p className="kb-hero-lead animate-fade-in-up">
                                Apex coordinating agency ensuring a <strong>Drug-Free India</strong>. We are committed to stringent enforcement, intelligence rooted in <strong>Article 47</strong>, and international cooperation for a safer tomorrow.
                            </p>

                            <div className="kb-hero-cta-group animate-fade-in-up">
                                <a href="/about" className="kb-btn-primary-hero">
                                    EXPLORE <i className="bi bi-arrow-right"></i>
                                </a>
                                <a href="#contact" className="kb-btn-outline-hero">
                                    CONTACT US
                                </a>
                            </div>

                            <div className="kb-hero-social-row animate-fade-in-up">
                                <span className="kb-social-label">Connect:</span>
                                <a href="#" className="kb-social-btn" aria-label="Twitter/X">
                                    <i className="bi bi-twitter-x"></i>
                                </a>
                                <a href="#" className="kb-social-btn" aria-label="Facebook">
                                    <i className="bi bi-facebook"></i>
                                </a>
                                <a href="#" className="kb-social-btn" aria-label="Instagram">
                        ...
                        {/* RIGHT CAROUSEL CARD */}
                        <div className="kb-hero-slider-col">
                            <div className="kb-hero-card-slider">
                                {slides.map((slide, index) => (
                                    <div
                                        key={slide.id}
                                        className={`kb-hero-slide ${index === currentIndex ? "active" : ""}`}
                                    >
                                ...
                                <div className="kb-carousel-dots">
                                    {slides.map((_, i) => (
                                        <button
                                            key={i}
                                            className={`kb-carousel-dot ${i === currentIndex ? "active" : ""}`}
                                ...
                                <button className="kb-carousel-ctrl kb-carousel-prev" onClick={prevSlide} aria-label="Previous Slide">
                                    <i className="bi bi-chevron-left"></i>
                                </button>
                                <button className="kb-carousel-ctrl kb-carousel-next" onClick={nextSlide} aria-label="Next Slide">
